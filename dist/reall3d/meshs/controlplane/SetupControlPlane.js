...
import { ControlPlaneUpdate, ControlPlaneSwitchVisible, GetCameraLookAt, GetCameraLookUp, GetControlPlane, GetScene, ViewerNeedUpdate, IsControlPlaneVisible, } from '../../events/EventConstants';
import { ArrowHelper } from './ArrowHelper';
export function setupControlPlane(events) {
    ...
    on(ControlPlaneSwitchVisible, (visible) => {
    ...
    on(ControlPlaneUpdate, (force = false) => {
